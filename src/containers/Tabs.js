    ...
    return (
        <div className="logotel-tabs">
            ...
            <div className="logotel-tabs--card logotel-tabs--card-pink">
                <div className="logotel-tabs--card--title pink">TAB ROSA</div>
                ...
                <div className="logotel-tabs--card--cta bg-pink">
                    CALL TO ACTION
                </div>
            </div>
            <div className="logotel-tabs--card logotel-tabs--card-yellow">
                <div className="logotel-tabs--card--title yellow">TAB GIALLA</div>
                ...
                <div className="logotel-tabs--card--cta bg-yellow">
                    CALL TO ACTION
                </div>
            </div>
            <div className="logotel-tabs--card logotel-tabs--card-turquoise">
                <div className="logotel-tabs--card--title turquoise">TAB TURCHESE</div>
                ...
                <div className="logotel-tabs--card--cta bg-turquoise">
                    CALL TO ACTION
                </div>
            </div>
        </div>
